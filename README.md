...
```bash
pip install https://github.com/anthonychu/copilot-functions/releases/download/v0.6.3/copilot_functions-0.6.3-py3-none-any.whl
```
...
```bash
# From release URL
pip install "copilot-functions[connectors] @ https://github.com/anthonychu/copilot-functions/releases/download/v0.6.3/copilot_functions-0.6.3-py3-none-any.whl"
...
```
https://github.com/anthonychu/copilot-functions/releases/download/v0.6.3/copilot_functions-0.6.3-py3-none-any.whl
```
...
# Output: dist/copilot_functions-0.6.3-py3-none-any.whl
```
